...
export default function Testimonial(props: { id: string }): JSX.Element {
                ...
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      ...
                      I patronized Ehizeex and when He delivered, I honestly fell in love with the project He is a very
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      <i className="fa fa-quote-left" />
                      It was nice hiring this guy for my e-commerce project.He delivered even more than i can imagine. I
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      <i className="fa fa-quote-left" />
                      When he delivered my job, my head spined, it was so nice and he implemented every functionality i
                      requested for. Thank you.
                      <i className="fa fa-quote-right" />
                    </p>
                    <ul className="stars list-unstyled">
                      <li>
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      <i className="fa fa-quote-left" />
                      This guy is incredibly awesome, I hired him and when He delivered, I honestly fell in love with the
                      project. He is indeed a great guy,
                      <i className="fa fa-quote-right" />
                    </p>
                    <ul className="stars list-unstyled">
                      <li>
