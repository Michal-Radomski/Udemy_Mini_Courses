...
const Resume = (props: { id: string }): JSX.Element => {
  ...
  const fadeInSubscription = ScrollService.currentScreenFadeIn.subscribe(fadeInScreenHandler as any);
  ...
  const projectsDetails = [
    ...
    },
    {
      title: "Mobile E-shop ",
      duration: { fromDate: "2020", toDate: "2021" },
      description: "An e-commerce application designed to sell products online wth payment system integration",
  ...
  const resumeDetails = [
    ...
    <div className="resume-screen-container" key="work-experience">
      <div className="experience-container">
        ...
        <div className="experience-description">
          <span className="resume-description-text">
            - Developed an e-commerce website for client with the dashboard for managing the products, managing reviews,
            users, payment etc. .
          </span>
          <br />
          <span className="resume-description-text">
            - Integrated the web app with backend services to create new user onboarding application with dynamic form
            content.{" "}
          </span>
          <br />
          <span className="resume-description-text">
